 ...
 */
public class EsAutoFast extends LinearOpMode {
    DcMotor tiltMotor;
    DcMotor panMotor;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        bZip.setPosition(EsBot.BZIP_UP);
        rZip.setPosition(EsBot.RZIP_UP);
        ...
        if (blueTeam) {
            if (startPos == 0) {
                drive(0, -.6, new DistanceStop(3200));
                drive(35, -.6, new DistanceStop(8500));
            } else {
                drive(0, -.35, new DistanceStop(2400));
                drive(35, -.35, new DistanceStop(10000));
            }
            sleep(250);
            drive(30, .6, new DistanceStop(1800));
            drive(100, -.13, new DistanceStop(1800), new ColorStop());
            // fenderUp();
            sleep(250);
            drive(heading(), -.12, new DistanceStop(1500), new USStop(14), new TimeStop(time, 5000));
            drive(85, 0.12, new DistanceStop(300));//HTO
            drive(85, -0.12, new DistanceStop(500), new USStop(14), new TimeStop(time, 5000));//hto
            ...
            drive(heading(), -.12, new DistanceStop(1500), new USStop(14), new TimeStop(time, 5000));
            drive(-85, 0.12, new DistanceStop(300));//hto
            drive(-85, -0.12, new DistanceStop(6500), new USStop(14), new TimeStop(time, 5000));//hto
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void fenderDown() {
        ...
        //fenderl.setPosition(EsBot.LFENDER_DOWN);
        fenderr.setPosition(EsBot.RFENDER_DOWN);
    }


    public void fenderUp() {
        //fenderl.setPosition(EsBot.LFENDER_UP);
        fenderr.setPosition(EsBot.RFENDER_UP);
    }
    ...
    public void climberScore() throws InterruptedException {
        ...
        if ((blueTeam && rcolor.blue() > rcolor.red())
            ...
            panRight(-100);
            drive(heading(), -0.15, new DistanceStop(250), new TimeStop(time, 1));
            sleep(250);
            drive(heading(), 0.3, new DistanceStop(500), new TimeStop(time, 3));
            panLeft(0);
